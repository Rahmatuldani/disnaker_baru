...
<div class="container mt-4">
    ...
    <nav class="nav nav-borders">
        ...
        <a class="nav-link" href="{{ route('bkk.bkk') }}">BKK</a>
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('bkk.profile', 'edit') }}" method="POST" id="profileEdit">
                        @csrf
                        <!-- Form Row        -->
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="nama" name="nama" type="text" value="{{ $akun->nama }}" />
                            </div>
                        </div>
                        <!-- Form Row        -->
                        <div class="form-row">
